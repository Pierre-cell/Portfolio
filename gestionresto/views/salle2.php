      ...
      <div class="tableau">
        <table>
          ...
          <tbody>
            ...
            <?php
            $query = $bdd->query('SELECT clients.nom as clientnom, clients.prenom as clientpre, tableR, ranger.salle as salle, dateR, nbC FROM `reserver`Inner join clients On reserver.client=clients.mail Inner join tables On reserver.tableR=tables.num Inner join ranger On tables.num=ranger.tableS where ranger.salle="salle 2"
      ');

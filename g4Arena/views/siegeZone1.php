...
<head>
    ...
    $totalselect = $bdd->query('SELECT COUNT(*) As totalselect From places Where statut="selected" and id_zone="1"');
...
<body>
    ...
    ?>
    <div class=titre>
        <H2>Bienvenue dans la zone 1</H2>
        ...
        <div class="panier">
            ...
            <div class="prixTotal">
                ...
                $prix = 'SELECT SUM(prix) AS prix 
                    ...
                    WHERE id_zone = 1 AND statut = "selected"';
    ...
    <?php
    // $requetePlaces = $bdd->prepare('SELECT * FROM places WHERE id_event = ' . $id_event . ' AND id_zone =' . $id_zone . ' ');
    // $requetePlaces->execute(array($requetePlaces));
    // $placesResult = $requetePlaces->fetch();


    // $requeteRang = $bdd->prepare('SELECT rang FROM places WHERE id_event = ' . $id_event . ' AND id_zone = ' . $id_zone . '');
    // $requeteRang->execute(array());


    // $statut = $placesResult['statut'];

    // 
    ?><div class="placeZone1top">
        <table>
            <?php
            //         foreach ($requeteRang as $rang => $rang) {
            //             if ($statut == 'reserve') {
            //                 include './siegeReserveZone1.php';
            //             }

            //             if ($statut == 'dispo') {
            //                 include './siegeDispoZone1.php';
            //             }

            //             if ($statut == 'selected') {
            //                 include './siegeSelectedZone1.php';
            //             }
            //         }
            //         
            ?>
    ...
    <div class="placeZone1top">
        <table>
            ...
            $requete1a25 = 'SELECT * FROM places WHERE rang = "A" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete26a50 = 'SELECT * FROM places WHERE rang = "B" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete51a75 = 'SELECT * FROM places WHERE rang = "C" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete76a100 = 'SELECT * FROM places WHERE rang = "D" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete101a125 = 'SELECT * FROM places WHERE rang = "E" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete126a150 = 'SELECT * FROM places WHERE rang = "F" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "G" AND id_event = ' . $id_event . ' AND id_zone = 1';
    ...
    <div class="placeZone1">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "H" AND id_event = ' . $id_event . ' AND id_zone = 1';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone1">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "I" AND id_event = ' . $id_event . ' AND id_zone = 1';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone1">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "J" AND id_event = ' . $id_event . ' AND id_zone = 1';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone1">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "K" AND id_event = ' . $id_event . ' AND id_zone = 1';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone1Bottom">
        <?php
        $requete176a200 = 'SELECT * FROM places WHERE rang = "L" AND id_event = ' . $id_event . ' AND id_zone = 1';
            ...
            <form action="./siegeZone1_controller.php?id_event=<?= $valeurs['id_event'] ?>" method="post">
                ...
                <div class="placesselected">
                    ...
                    <div class="idselected">
                        <?php
                        $selected = 'SELECT * From places Where statut="selected" AND id_event = ' . $id_event . ' And id_zone = 1';

...
<head>
    ...
    $totalselect = $bdd->query('SELECT COUNT(*) As totalselect From places Where statut="selected" and id_zone= 6 AND id_event = ' . $id_event . '');
...
<body>
    ...
    <div class="recap">
        ...
        <div class="vosPlaces">
            ...
            $selected = 'SELECT * From places Where statut="reserve" AND id_zone = 6 AND id_user=' . $idUser . ' AND id_event = ' . $id_event . '';
        ...
        <div class="total">
            ...
            $prix = 'SELECT SUM(prix) AS prix 
                    ...
                    WHERE id_zone = 6 AND statut = "reserve" AND id_user = ' . $idUser . ' AND id_event = ' . $id_event . '';

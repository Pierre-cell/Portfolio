...
<head>
    ...
    $totalselect = $bdd->query('SELECT COUNT(*) As totalselect From places Where statut="selected" and id_zone="4"');
...
<body>
    ...
    ?>
    <div class=titre>
        <H2>Bienvenue dans la zone 4</H2>
        ...
        <div class="panier">
            ...
            <div class="prixTotal">
                ...
                $prix = 'SELECT SUM(prix) AS prix 
                    ...
                    WHERE id_zone = 4 AND statut = "selected"';
    ...
    <div class="placeZone4top">
        <table>
            <?php

            $mysqli->set_charset("utf8");
            $requete1a25 = 'SELECT * FROM places WHERE rang = "A" AND id_event = ' . $id_event . ' AND id_zone = 4';
            ...
            while ($ligne = $resultat->fetch_assoc()) {
                ...
                if ($statut == 'reserve') {
                    include './siegeReserveZone4.php';
                }

                if ($statut == 'dispo') {
                    include './siegeDispoZone4.php';
                }

                if ($statut == 'selected') {
                    include './siegeSelectedZone4.php';
                }
            }
            ?>
        </table>
    ...
    <div class="placeZone4">
        <?php
        $requete26a50 = 'SELECT * FROM places WHERE rang = "B" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete51a75 = 'SELECT * FROM places WHERE rang = "C" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete76a100 = 'SELECT * FROM places WHERE rang = "D" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete101a125 = 'SELECT * FROM places WHERE rang = "E" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete126a150 = 'SELECT * FROM places WHERE rang = "F" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "G" AND id_event = ' . $id_event . ' AND id_zone = 4';
    ...
    <div class="placeZone4">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "H" AND id_event = ' . $id_event . ' AND id_zone = 4';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone4">
        <?php
        $requete151a175 = 'SELECT * FROM places WHERE rang = "I" AND id_event = ' . $id_event . ' AND id_zone = 4';
        $resultat151a175 = $mysqli->query($requete151a175);
        ?>
        <table>
            <?php
    ...
    <div class="placeZone4Bottom">
        <?php
        $requete176a200 = 'SELECT * FROM places WHERE rang = "J" AND id_event = ' . $id_event . ' AND id_zone = 4';
            ...
            <form action="./siegeZone4_controller.php?id_event=<?= $valeurs['id_event'] ?>" method="post">
                ...
                <div class="placesselected">
                    ...
                    <div class="idselected">
                        <?php
                        $selected = 'SELECT * From places Where statut="selected" And id_zone = 4';
